...
// Attention to the pin connection (mainly bmp180) 
...
//************BMP start
//Ref https://blogmasterwalkershop.com.br/arduino/como-usar-com-arduino-sensor-de-pressao-e-temperatura-bmp180
...
//******** DHT22 loop start ********//
  ...
  Serial.println("****** Sensor DHT22 ******"); //IMPRIME O TEXTO NO MONITOR SERIAL
...
//************BMP start loop
    Serial.println("****** Sensor BMP180 ****** "); //IMPRIME O TEXTO NO MONITOR SERIAL
    Serial.print("Temperatura: "); //IMPRIME O TEXTO NO MONITOR SERIAL
    Serial.print(bmp.readTemperature()); //IMPRIME NO MONITOR SERIAL A TEMPERATURA
    Serial.print(" *C (Grau Celsius)  |"); //IMPRIME O TEXTO NO MONITOR SERIAL
